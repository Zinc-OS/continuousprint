	...
	function ContinuousPrintViewModel(parameters) {
		...
		self.loadQueue = function() {
            ...
            if(CMD=="UP"){
                ...
                var temp3 = $("#queue_list").children(".n"+data).children(".queue-row-container").children(".queue-inner-row-container").children(".file-name").val();
                var temp4 = $("#queue_list").children(".n"+data-1).children(".queue-row-container").children(".queue-inner-row-container").children(".file-name").val();
                ...
                $("#queue_list").children(".n"+data).children(".queue-row-container").children(".queue-inner-row-container").children(".file-name").attr("value",parseInt(temp4));
                $("#queue_list").children(".n"+data-1).children(".queue-row-container").children(".queue-inner-row-container").children(".file-name").attr("value",parseInt(temp3));
